...
🔍 <b>البحث عن حديث (في الخاص أو المجموعات):</b>
   ...
   - <i>في المجموعات، قد تحتاج لذكر البوت (<code>@{(await client.get_me()).username}</code>) إذا كان وضع الخصوصية مفعل. الأفضل تعطيله عبر @BotFather.</i>
...
取消 <b>إلغاء الإضافة:</b>
   - أرسل /cancel في أي وقت خلال عملية الإضافة لإلغائها.

💡 <b>ملاحظات هامة:</b>
   - يتم البحث في نص الحديث بعد إزالة التشكيل وعلامات الترقيم وتوحيد بعض الحروف.
